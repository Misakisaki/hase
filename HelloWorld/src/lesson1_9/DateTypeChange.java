...
public class DateTypeChange {
	...
	public static void main(String[] args) {
		...
		if(score <= 40) {
			System.out.println(name+"は"+score+"点です。もう少し頑張りましょう。");
		}else if(score >= 40 && score <=60 ) {
			System.out.println(name+"は"+score+"点です。もう少しでした。");
		}else if(score >= 60 && score <=80 ) {
			System.out.println(name+"は"+score+"点です。よくできました。");
		}else if(score >= 80)	
			System.out.println(name+"は"+score+"点です。たいへんよくできました。");
